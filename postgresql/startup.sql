...
--
-- Name: merge_train_departure_info(character varying, character varying, character varying, character varying, character varying, character varying, character varying, integer, character varying, character varying, character varying, character varying, integer, timestamp without time zone, timestamp without time zone, numeric, numeric, numeric, double precision); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.merge_train_departure_info(new_train_id character varying, new_real_train_id character varying, new_departure_station_name character varying, new_departure_station_code character varying, new_line_name character varying, new_line_code character varying, new_direction_name character varying, new_direction_number integer, new_scheduled_destination_station_name character varying, new_scheduled_destination_station_code character varying, new_observed_destination_station_name character varying, new_observed_destination_station_code character varying, new_observed_num_cars integer, new_observed_departure_time timestamp without time zone, new_scheduled_departure_time timestamp without time zone, new_observed_time_since_last_departure numeric, new_scheduled_time_since_last_departure numeric, new_headway_deviation numeric, new_schedule_deviation double precision) RETURNS boolean
    LANGUAGE plpgsql
    AS $$
BEGIN
  LOOP
...
ALTER FUNCTION public.merge_train_departure_info(new_train_id character varying, new_real_train_id character varying, new_departure_station_name character varying, new_departure_station_code character varying, new_line_name character varying, new_line_code character varying, new_direction_name character varying, new_direction_number integer, new_scheduled_destination_station_name character varying, new_scheduled_destination_station_code character varying, new_observed_destination_station_name character varying, new_observed_destination_station_code character varying, new_observed_num_cars integer, new_observed_departure_time timestamp without time zone, new_scheduled_departure_time timestamp without time zone, new_observed_time_since_last_departure numeric, new_scheduled_time_since_last_departure numeric, new_headway_deviation numeric, new_schedule_deviation double precision) OWNER TO postgres;
...
--
-- Name: array_accum(anycompatiblearray); Type: AGGREGATE; Schema: public; Owner: postgres
--
...
ALTER AGGREGATE public.array_accum(anycompatiblearray) OWNER TO postgres;
